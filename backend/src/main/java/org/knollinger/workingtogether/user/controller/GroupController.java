...
import org.knollinger.workingtogether.user.dtos.CreateGroupRequestDTO;
import org.knollinger.workingtogether.user.dtos.GroupDTO;
import org.knollinger.workingtogether.user.dtos.SaveGroupMemberseRquestDTO;
...
public class GroupController
{
    ...
    public void saveGroupMembers(@RequestBody() SaveGroupMemberseRquestDTO req)
    {
        try
        {
            this.groupSvc.saveGroupMembers(req.getParent(), req.getMembers());
        }
